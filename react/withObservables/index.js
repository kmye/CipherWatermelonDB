...
var WithObservablesComponent = /*#__PURE__*/function (_Component) {
  ...
  ;
  _proto.subscribeWithoutSettingState = function (props) {
    var _this2 = this;
    this.unsubscribe();
  ...
  ;
  _proto.withObservablesOnChange = function (values) {
  ...
  // DO NOT rename (we want on call stack as debugging help)
  ;
  _proto.withObservablesOnError = function (error) {
  ...
  _proto.cancelPrefetchTimeout = function () {
